...
## Project Structure
    ...
    ├── testapiautoconnecto_78510  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnecto_78510`
...
2. Clone this repo and `cd testapiautoconnecto_78510`
